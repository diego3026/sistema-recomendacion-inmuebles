...
urlpatterns = [
    ...
    path('api/inmueblesPorUsuario/<str:usuario>/recomendaciones/', InmueblePorUsuarioViewSet.as_view({'get': 'get_recomendations'}), name='inmuebles_por_usuario_get_recomendations'),    
    path('api/inmueblesPorUsuario/obtener/', InmueblePorUsuarioViewSet.as_view({'get': 'get_filtro'}), name='inmuebles_por_usuario_filtrado'),    
